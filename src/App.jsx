...
import WayaChat from "./pages/wayachat/Wayachat";
...
function App() {
  const [isDownloadModalOpen, setIsDownloadModalOpen] = useRecoilState(downloadModalState);
  ...
  return (
    <div>
      <ToastContainer />
      <DownloadModal isOpen={isDownloadModalOpen} toggle={toggleDownloadModal} />
      <Router>
        <Switch>
