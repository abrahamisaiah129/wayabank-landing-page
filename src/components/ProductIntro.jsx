        ...
        <div className="flex flex-col py-8 px-8 md:px-0">
            <div className="w-full h-auto md:h-screen grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="w-full md:w-4/5 pr-10 flex flex-col items-start justify-center ...">
                    <h4 data-aos="fade-up" className="title text-3xl font-semibold">Get onboarded and begin accepting payments in no time.</h4>
                    <ul className="mt-8">
            ...
            <div className="flex flex-col items-center mt-20 md:mt-0">
                <h4 data-aos="fade-up" data-aos-delay="300" className="title2 text-primary-theme text-4xl font-semibold">Wayapay Prducts</h4>

                <div data-aos="fade-up" data-aos-delay="300" className="toggle mt-6 border border-gray-100 flex items-center w-full md:w-1/5 h-14 rounded-full bg-gray-100 relative ...">
