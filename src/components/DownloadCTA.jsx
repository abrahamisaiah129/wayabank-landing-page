...
function DownloadCTA() {
    ...
    return (
        <div data-aos="fade-up" className="download-container px-8 md:px-20">
           <div className="download-cta-container py-12 w-full h-auto md:h-96 bg-primary-theme rounded-3xl grid grid-cols-1 md:grid-cols-3">
                <div className="flex items-start md:items-end justify-start md:justify-end">
                    <img src={PhoneInHand} alt="" width="64%"/>
                </div>
                <div className="pl-8 md:pl-16 pt-16 md:pt-28 col-span-2 pr-16 md:pr-64">
                    <h4 className="text-white font-semibold text-4xl md:text-6xl pr-12 md:pr-32">Download the app</h4>
