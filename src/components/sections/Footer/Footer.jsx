      ...
      <div className="footer-nav-container">
        ...
        <div className="footer-nav-group">
          ...
          <ul>
            ...
            <li><a href="/developer/docs">API Documentation</a></li>
        ...
        <div className="footer-nav-group">
          <h3>Legal</h3>
          <ul>
            <li><a href="/privacy-page">Privacy Notice</a></li>
      ...
      <div className="footer-bottom">
        <div className="footer-logo-socials">
          <div className="footer-logo">
            <img src={Logo} alt="Wayabank" className="h-10 w-auto" />
          </div>
          <div className="footer-socials">
            ...
            <a href={social.facebook || "#"} target="_blank" rel="noreferrer" className="social-link">
              <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href={social.instagram || "#"} target="_blank" rel="noreferrer" className="social-link">
        ...
        <div className="footer-legal-apps">
          <div className="legal-text">
            Wayabank Limited is a company registered in Nigeria. Wayabank is licensed by the Central Bank of Nigeria (CBN) and all deposits are insured by the Nigeria Deposit Insurance Corporation (NDIC).
            <div className="footer-copyright">
              &copy; {new Date().getFullYear()} Wayabank. All rights reserved.
            </div>
          </div>
          <div className="app-store-badges">
            <a href="#" className="app-badge"><img src={AppStoreImg} alt="App Store" /></a>
            <a href="#" className="app-badge"><img src={PlayStoreImg} alt="Google Play" /></a>
          </div>
        </div>
      </div>
    </footer>
