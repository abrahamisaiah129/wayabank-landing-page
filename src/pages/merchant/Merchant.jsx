    ...
    <div>
      ...
      <div id="merchantPage" className="">
        <div className="main-jumbotron pb-4 mb-4">
          <Fade right cascade>
            <div className="row">
              <div className='col-md-12 text-center pt-lg-4 mt-4'>
                <h1 className="section-title">{merchants.hero_title}</h1>
                <div className="section-divider" />
                <p className='section-subtitle'>{merchants.hero_description}</p>
